...
R package **mredgebuildings**, version **0.1.2**
...
Krekeler R, Führlich P, Levesque A (2022). _mredgebuildings: Prepare data to be used by the EDGE-Buildings model_. R package version 0.1.2.
