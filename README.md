...
R package **mredgebuildings**, version **0.1.4**
...
Hasse R, Führlich P, Levesque A (2023). _mredgebuildings: Prepare data to be used by the EDGE-Buildings model_. R package version 0.1.4, <URL: https://github.com/pik-piam/mredgebuildings>.
