...
R package **mredgebuildings**, version **0.3.1**
...
Hasse R, Führlich P, Levesque A, Tockhorn H (2023). _mredgebuildings: Prepare data to be used by the EDGE-Buildings model_. R package version 0.3.1, <https://github.com/pik-piam/mredgebuildings>.
