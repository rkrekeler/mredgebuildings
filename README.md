...
R package **mredgebuildings**, version **0.7.9**
...
Hasse R, Führlich P, Levesque A, Tockhorn H (2024). _mredgebuildings: Prepare data to be used by the EDGE-Buildings model_. R package version 0.7.9, <https://github.com/pik-piam/mredgebuildings>.
